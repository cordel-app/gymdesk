...
- [ ] **Migration 178 must run *after* the API build that stops reading the Promotion
...
- [ ] **Migration 178 keeps only the membership-fee rows** (#635 stage 5): a Promotion's
      ...
      next recompute; the migration logs those promotion ids (`[178] These Promotions
