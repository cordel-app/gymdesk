...
| Payment Providers | — | `[locale]/financials/payment-providers/` (placeholder until #182) | FINANCIALS module (#159). Platform payment infrastructure config (Monei first — see #179–#185; Stripe Phase 8 superseded). Moved from Payments to Financials. |
