/**
 * Frontend mirror of `api/src/infra/permissions.ts`.
 * API is the source of truth — keep these matrices identical.
 * Used for sidebar visibility (`canAccessModule`) and write affordances (`canWriteModule`).
 */
