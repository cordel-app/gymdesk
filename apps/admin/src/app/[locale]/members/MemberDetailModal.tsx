    ...
    <div style={overlayStyle} onClick={onClose}>
      <div style={{ ...modalStyle, width: 540, maxHeight: '90vh', overflowY: 'auto' }} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 20 }}>
          {/* #642/#675: deep-link to the Audit Log filtered to this member by entity
              id — never by name, which is neither unique nor stable. */}
          <ViewAuditLogButton entityType="member" entityId={memberId} onNavigate={onClose} />
